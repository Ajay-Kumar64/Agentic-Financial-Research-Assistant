    ...
    def __init__(self, api_key: str = None, model_name: str = "gemini-3.1-flash-lite"):
        ...
        if self.api_key:
            try:
                ...
                print("[HyDE] google-genai not installed. HyDE disabled.")
...
class CRAGEvaluator:
    ...
    def __init__(self, api_key: str = None, threshold: float = 0.35, model_name: str = "gemini-3.1-flash-lite"):
        self.api_key = api_key or os.environ.get("GOOGLE_API_KEY")
...
class SmartRetriever:
    ...
    def retrieve(
        ...
        # 4. Encode query
        t3 = time.time()
        embedding = self.embedder.encode(search_query, normalize_embeddings=True)
        # CRITICAL: Convert numpy array to list of Python floats
        # This prevents serialization issues in opensearch-py
